            ...
            <div class="row">
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <p style="margin-top: 10px;"> <span class="fas fa-calendar"></span>
                            <?= date("m/d/Y", strtotime($event->getDate())) ?></p>
                        ...
                        <div class="col-sm-6 col-xs-6">
                            ...
                            <a class="btn btn-success btn-block text-uppercase font-weight-bold"
                                href="<?= $event->getLink() ?>">
                        ...
                        <div class="col-sm-6 col-xs-6">
                            ...
                            <a class="btn btn-primary btn-block text-uppercase font-weight-bold" target="_blank"
                                href="https://www.facebook.com/sharer/sharer.php?u=https://business-after-harvey.000webhostapp.com/event?id=<?= $event->getId() ?>">
                ...
                <div class="panel-heading text-center text-uppercase text-capitalize">
                    ...
                    <form>
                        <div class="input-group">
                            <input type="text" name="event-title" id="input-event-title" class="input-lg form-control"
