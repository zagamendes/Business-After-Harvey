...
<div class="container">
    ...
    <table class="table table-striped table-hover">
        ...
        <tbody>
            ...
            <tr>
                <td><img src="../img/events/<?= $event->getPhoto() ?>" style="max-width: 320px; max-height: 160px;"
                        class="img-responsive"></td>
                <td><?= $event->getTitle(); ?></td>
                <td>
                    <a class="btn btn-primary btn-block text-uppercase font-weight-bold"
                        href="event?id=<?= $event->getId(); ?>"><span class="fas fa-edit"></span> Edit </a>

                </td>
                <td><a class="btn btn-danger btn-block text-uppercase font-weight-bold"
                        onclick="return confirm('are you sure that you want to delete this?');"
                        href="processes/delete?id=<?= $event->getId(); ?>&table=event&photo=<?= $event->getPhoto(); ?>&page=events">
