    ...
    <div class="row">
        <div class="col-sm-6">
            <form action="processes/about" method="post">
                ...
                <button class="btn btn-success form-control font-weight-bold text-uppercase"
                    style="margin-bottom: 20px;">Save <span class="fas fa-check-circle"></span></button>
            </form>
        </div>
        ...
        <div class="col-sm-12">
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <img src="../img/<?= $photo->getFolder(); ?>/<?= $photo->getPhoto() ?>"
                                style="width: 100px;" class="img-responsive">
                        </td>
                        <td class="text-center">
                            <form method="post" action="processes/photo" enctype="multipart/form-data">
                                ...
                                <button type="submit" name="update" value="Save Photo"
                                    class="btn btn-success text-uppercase font-weight-bold"><span
                                        class="fas fa-check"></span> Save</button>

                            </form>
                        </td>

                        <td>
                            <a class="btn btn-danger text-uppercase font-weight-bold"
                                onclick="return confirm('are you sure that you want to delete this?');"
                                href="processes/delete?id=<?= $photo->getId(); ?>&table=photos_about&photo=<?= $photo->getPhoto(); ?>&page=about&folder=<?= $photo->getFolder(); ?>">
