		...
		<div class="container">
			...
			?>
				...
				<div class="row" style="margin-top: 20px;">
					...
					<div class="col-sm-6">
						<button class="btn btn-lg btn-block text-uppercase font-weight-bold label-dashboard" data-toggle="modal" data-target="#album"> 
				...
				<div class="row">
					<div class="col-sm-6">
						<button class="btn btn-lg btn-block text-uppercase font-weight-bold label-dashboard" data-toggle="modal" data-target="#home"> 
							<span class="fas fa-images"></span> Add photos to home page 
						</button>
					</div>

					<div class="col-sm-6">
						<button class="btn btn-lg btn-block text-uppercase font-weight-bold label-dashboard" data-toggle="modal" data-target="#about"> 
					...
					<div class="modal-body">
						...
						<form method="post" action="processes/photo" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input type="text" required name="title" class="form-control" placeholder="Name of the Event">
							</div>
							<div class="form-group">
								<label class="btn  btn-primary font-weight-bold btn-block text-uppercase">select photos <span class="fas fa-images"></span>
									<input type="file" style="position: absolute;z-index: -1; width: 0;" required name="photosDash[]" multiple class="form-control">
								</label>
							</div>
							<div class="form-group">
								<label class="text-uppercase" >Description:</label>
								<textarea required name="description" class="form-control" id="album-description" maxlength="30" required rows="4" >
								</textarea>
							</div>
							<div class="row">
								<div class="col-sm-6">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<label class="btn btn-primary btn-lg btn-block font-weight-bold text-uppercase">
							...
							<input type="file" name="photos[]" multiple style="position: absolute; z-index: -1; width: 0">
						</label>
					</div>
					<div class="modal-footer">
						<button type="submit" class="btn btn-success btn-lg text-uppercase font-weight-bold"><span class="fas fa-check-circle"></span> Save</button>
						<button class="btn btn-danger text-uppercase btn-lg font-weight-bold" data-dismiss="modal"><span class="fas fa-times"></span> Close</button>
					</div>
				</div>
			</div>
		</form>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form method="post" action="processes/photo" enctype="multipart/form-data">
						...
						<div class="form-group">
							<label class="btn  btn-primary font-weight-bold btn-block text-uppercase">select photo <span class="fas fa-images"></span>
