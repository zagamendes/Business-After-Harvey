    ...
    <div class="container">
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    <td><img src="img/about/<?= $photo1->getPhoto() ?>" style="width: 100px;" class="img-responsive">
                    </td>
                    <td>
                    ...
                    <td><a onclick="return confirm('are you sure that you want to delete this?');"
                            href="delete.php?id=<?= $photo1->getId(); ?>&table=photos_about&photo=<?= $photo1->getPhoto(); ?>&page=edit_about_photos&folder=about">
