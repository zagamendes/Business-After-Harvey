...
<html>
    ...
    <table class="table table-hover">
            ...
            <tbody>
    <?php foreach ($photosIndex as $photo1) { ?>
        
            
                <tr>
                    <td><img src="img/index/<?=$photo1->getPhoto()?>" style="width: 100px;" class="img-responsive"></td>
                    <td>
                        <form method="post" action="save photo.php" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="page" value="edit-index-pictures">
                    ...
                    <td><a onclick="return confirm('are you sure that you want to delete this?');" href="delete.php?id=<?=$photo1->getId();?>&table=photos_slideshow&photo=<?=$photo1->getPhoto();?>&page=edit-index-pictures&folder=index">
