...
<div class="container">
    ...
    <div class="row">
        <button class="btn btn-primary btn-lg font-weight-bold text-uppercase" id="btn-contact" data-toggle="modal"
            data-target="#myModal">CONTACT US <span class="fas fa-envelope"></span></button>
    </div>
            ...
            <div class="modal-content">
                ...
                <form>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-danger text-uppercase font-weight-bold" value="Send"
                            data-dismiss="modal">
