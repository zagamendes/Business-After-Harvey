...
<div class="container">
  <div class="row">
    <div class="col-sm-6">
      ...
      <p>
        Business disruptions are inevitable. A well prepared business can protect themselves from becoming one
        of the 40% to 60% of businesses that do not open after a disaster.  Simple steps taken now can mean the
        difference between staying open or closing for good.  
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-sm-2" data-target="#myModal" data-toggle="modal">
        ...
        <h3>LOCAL</h3>
        <p><span class="fas fa-check"></span> Harris Country Department of Homeland Safety & Emergency
          Management</p>
